...
CREATE TABLE IF NOT EXISTS event_product_booth_link (
  id                      uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  product_event_prices_id   uuid NOT NULL REFERENCES product_event_prices(id) ON DELETE CASCADE,
  event_id                uuid NOT NULL REFERENCES events(id) ON DELETE CASCADE,
  booth_id                uuid NOT NULL REFERENCES booths(id) ON DELETE CASCADE,
  created_at              timestamptz NOT NULL DEFAULT now(),
  UNIQUE (product_event_prices_id, booth_id)
);
-- v této tabulce jsou delete i update povoleny
...
BEGIN
  IF TG_OP = 'INSERT' OR TG_OP = 'UPDATE' THEN
    ...
    SELECT event_id INTO event_product_price_event_id
      ...
      WHERE NEW.product_event_prices_id = id;

    IF NOT FOUND THEN
      RAISE EXCEPTION 'product_event_prices % does not exist', NEW.product_event_prices_id;
    END IF;
...
VALUES
('20000000000000000000000000000001', 'event1_2000_booth1', '["Hamburger", "Jídlo"]'),
('20000000000000000000000000000002', 'event1_2147483647_booth1aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', DEFAULT),
('20000000000000000000000000000003', 'event1_7_booth1 imageless', '["Jídlo"]'),
('20000000000000000000000000000004', 'event1_10000_booth2', DEFAULT),
('20000000000000000000000000000005', 'event1_345_booth1_2_kofola', '["Pití"]'),
('20000000000000000000000000000006', 'event2_123_booth1_rohlík', '["Pečivo"]'),
('20000000000000000000000000000007', 'event1_11111_2_22222_booth1', DEFAULT),
('20000000000000000000000000000008', 'hamburger 2', DEFAULT),
('20000000000000000000000000000009', 'Hamburger 3', DEFAULT);

INSERT INTO product_images (product_id, image_path, filename, content_type, size_bytes, width, height, alt_text)
VALUES
('20000000000000000000000000000001', '/static/images/products', 'hamburger1.png', 'image/png', 54289, 225, 225, 'Hamburger picture'),
('20000000000000000000000000000002', '/static/images/products', 'hamburger2.png', 'image/png', 1882222, 1500, 1125, 'Delicious hamburger picture'),
('20000000000000000000000000000004', '/static/images/products', 'hamburger3.png', 'image/png', 5308416, 1440, 2465, 'Tall delicious hamburger picture'),
('20000000000000000000000000000005', '/static/images/products', 'kofola.png', 'image/png', 163383, 250, 333, 'Kofola picture'),
('20000000000000000000000000000006', '/static/images/products', 'rohlík.png', 'image/png', 53810, 250, 177, 'Rohlík picture'),
('20000000000000000000000000000007', '/static/images/products', 'hamburger2.png', 'image/png', 1882222, 1500, 1125, 'Delicious hamburger picture');
...
VALUES
('40000000000000000000000000000001', 'development_booth1_event1_cashier', '30000000000000000000000000000001', 'cashier', '10000000000000000000000000000001', FALSE),
('40000000000000000000000000000002', 'development_booth2_event1_cashier', '30000000000000000000000000000001', 'cashier', '10000000000000000000000000000001', FALSE),

('40000000000000000000000000000003', 'development_booth1_event1_seller', '30000000000000000000000000000001', 'seller', '10000000000000000000000000000001', FALSE),
('40000000000000000000000000000004', 'development_booth2_event1_seller', '30000000000000000000000000000001', 'seller', '10000000000000000000000000000001', FALSE),
('40000000000000000000000000000005', 'development_booth3_event1_seller', '30000000000000000000000000000001', 'seller', '10000000000000000000000000000001', FALSE),
('40000000000000000000000000000006', 'development_booth4_event1_seller', '30000000000000000000000000000001', 'seller', '10000000000000000000000000000001', FALSE),

('40000000000000000000000000000007', 'development_booth1_event2_cashier', '30000000000000000000000000000002', 'cashier', '10000000000000000000000000000001', FALSE),

('40000000000000000000000000000008', 'development_booth1_event2_seller', '30000000000000000000000000000002', 'seller', '10000000000000000000000000000001', FALSE);

INSERT INTO selectable_categories (id, name, booth_id)
VALUES
(1, 'Jídlo', '40000000000000000000000000000003'),
(2, 'Pití', '40000000000000000000000000000003'),
(3, 'Pečivo', '40000000000000000000000000000003'),
(4, 'Jídlo', '40000000000000000000000000000004');
...
('60000000000000000000000000000002', '20000000000000000000000000000002', '30000000000000000000000000000001', 2147483647),
('60000000000000000000000000000003', '20000000000000000000000000000003', '30000000000000000000000000000001', 7),
('60000000000000000000000000000004', '20000000000000000000000000000004', '30000000000000000000000000000001', 10000),
('60000000000000000000000000000005', '20000000000000000000000000000005', '30000000000000000000000000000001', 345),
('60000000000000000000000000000006', '20000000000000000000000000000006', '30000000000000000000000000000002', 123),
('60000000000000000000000000000007', '20000000000000000000000000000007', '30000000000000000000000000000001', 11111),
('60000000000000000000000000000008', '20000000000000000000000000000007', '30000000000000000000000000000002', 22222);

INSERT INTO event_product_booth_link (id, product_event_prices_id, booth_id)
VALUES
('70000000000000000000000000000001', '60000000000000000000000000000001', '40000000000000000000000000000003'),
('70000000000000000000000000000002', '60000000000000000000000000000002', '40000000000000000000000000000003'),
('70000000000000000000000000000003', '60000000000000000000000000000003', '40000000000000000000000000000003'),
('70000000000000000000000000000004', '60000000000000000000000000000004', '40000000000000000000000000000004'),
('70000000000000000000000000000005', '60000000000000000000000000000005', '40000000000000000000000000000003'),
('70000000000000000000000000000006', '60000000000000000000000000000005', '40000000000000000000000000000004'),
('70000000000000000000000000000007', '60000000000000000000000000000006', '40000000000000000000000000000008'),
('70000000000000000000000000000008', '60000000000000000000000000000007', '40000000000000000000000000000003'),
('70000000000000000000000000000009', '60000000000000000000000000000008', '40000000000000000000000000000008');
