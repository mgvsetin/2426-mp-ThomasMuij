...
CREATE TABLE IF NOT EXISTS selectable_category_booth_link (
  selectable_category_id  int NOT NULL REFERENCES selectable_categories(id) ON DELETE CASCADE,
...
--   - jestli je event stejný u selectable_categories i booth a booth existuje (pokud booth_id není null)
...
('20000000000000000000000000000005', 'event1_345_booth1_2_kofola'),
('20000000000000000000000000000006', 'event2_123_booth1_rohlík'),
...
VALUES
(1, 'Jídlo', '30000000000000000000000000000001'),
(2, 'Hamburger', '30000000000000000000000000000001'),
(3, 'Pití', '30000000000000000000000000000001'),
(4, 'Pečivo', '30000000000000000000000000000001'),
(5, 'Jídlo', '30000000000000000000000000000002');

INSERT INTO selectable_category_booth_link (selectable_category_id, booth_id)
VALUES
(1, '40000000000000000000000000000003'),
(2, '40000000000000000000000000000003'),
(3, '40000000000000000000000000000003'),
(4, '40000000000000000000000000000003'),
(5, '40000000000000000000000000000008');

INSERT INTO selectable_category_product_link (selectable_category_id, product_id)
VALUES
(1, '20000000000000000000000000000001'),
(1, '20000000000000000000000000000003'),
(2, '20000000000000000000000000000001'),
(3, '20000000000000000000000000000005'),
(5, '20000000000000000000000000000006');
