...
function renderTransactions(transactions) {
  if (!transactions || transactions.length === 0) {
    transactionsTableBody.innerHTML = '<tr><td colspan="8" class="empty-message">Žádné transakce.</td></tr>';
    return;
  }
...
function showError(message) {
  transactionsTableBody.innerHTML = `<tr><td colspan="8" class="error-message">${escapeHTML(message)}</td></tr>`;
