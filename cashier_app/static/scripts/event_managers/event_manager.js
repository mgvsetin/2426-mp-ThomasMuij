...
// open graphs
document.getElementById('open-graphs').addEventListener('click', () => {
...
document.getElementById('add-manager').addEventListener('click', () => openAssignEmployeeModal(true));
document.getElementById('add-employee').addEventListener('click', () => openAssignEmployeeModal(false));
